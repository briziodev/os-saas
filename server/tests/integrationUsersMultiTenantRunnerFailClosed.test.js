...
const RUNNER_PATH = path.join(
  ...
  "tests",
  "integration",
  "usersMultiTenantIsolation.integration.js"
);
...
test(
  "runner users multi-tenant rejeita banco local normal antes de carregar db.js",
  () => {
...
test(
  "runner users multi-tenant rejeita host remoto antes de carregar db.js",
  () => {
    const result = runRejectedTarget({
