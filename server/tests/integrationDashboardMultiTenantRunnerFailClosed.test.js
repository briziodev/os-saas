...
const RUNNER_PATH = path.join(
  ...
  "tests",
  "integration",
  "dashboardMultiTenantIsolation.integration.js"
);
...
test(
  "runner dashboard multi-tenant rejeita banco local normal antes de carregar db.js",
  () => {
...
test(
  "runner dashboard multi-tenant rejeita host remoto antes de carregar db.js",
  () => {
    const result = runRejectedTarget({
